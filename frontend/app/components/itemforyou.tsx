...
const ItemForYou = ({ item }: ItemProps) => { 
    return (
        <div className="mb-12">
            <div className={`z-15 ${module.divCardImg}`}>
            ...
            <div className="flex justify-center h-10 -mt-6">
                <Link className={`${module.buttonrow} w-11/12 z-20 transition-all hover:bg-slate-900 hover:bg-opacity-10 flex justify-between px-3 leading-9 items-center`} href={`/collections/${item._id}`}>
