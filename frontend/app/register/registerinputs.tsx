...
const RegisterInputs = () => {
    ...
    const handleSubmit = async (event: any) => {
        event.preventDefault();
            try {
                console.log({name: name, phoneNumber: phone, phoneCode: parseInt(code), password: password})
                const response = await authService.register({name: name, phoneNumber: phone, phoneCode: parseInt(code), password: password})
