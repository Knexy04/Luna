    ...
    return (
        <>
            {props.doc.length > 0 ?
                ...
                <div className='w-full flex justify-center items-center font-bold h-[40vh]'>Товаров данной категории нет!</div>
            }
            {props.doc.length > 0 ? <div ref={sentinelRef} className={"w-full text-center font-bold mt-12"}>Вы долистали до конца</div> : ""}
        </>
    );
};
